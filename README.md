# Olá, eu sou o Anderson Gonzaga Nogueira 👋

### Analista de Sistemas | Monitoramento | Aspirante a Desenvolvedor Full Stack & QA

---

- 🔭 **Atualmente:** Atuando como Analista de Monitoramento e focado em transição de carreira para Desenvolvimento de Software.
- 🎓 **Educação:** Pós-graduando em **Inteligência Artificial** (Anhembi Morumbi).
- 🛠️ **Tech Stack:** Sólida base em infraestrutura e expandindo para o desenvolvimento moderno.
- ⚡ **Interesses:** Automação, performance de hardware, setups de áudio Hi-Fi e inovação.
